...
public class LibraryChangelog {
    ...
    public void insertAuthors(AuthorRepository repository) {
        ...
        aliceAuthor = repository.save(new Author("2", "Alice Author"));
    ...
    public void insertBooks(BookRepository repository) {
        ...
        repository.save(new Book("2", "Alice in wonderland", aliceAuthor, fairyTale));
    ...
    public void insertUsers(UserRepository repository) {
        ...
        repository.save(new User("2", "user", "user",
